...
export const Cart = () => {
  return (
    <div className='container'>
      <div className='pv-5 text-center'>
        <img
          className='d-block mh-auto mb-4'
        ...
        <p>
          ...
          group has a validation state that can be triggered by attempting to submit the form
          without completing it.
        </p>
      </div>
      <div className='row g-5'>
        <div className='col-5 col-md-4'>
          <h4 className='d-flex jc-between ai-center mb-3'>
            <span className='text-primary'>Your cart</span>
            <span className='badge bg-primary rounded-pill'>3</span>
          </h4>
          <ul className='list-group mb-3'>
            <li className='list-group-item d-flex jc-between lh-sm'>
              <div>
            ...
            <li className='list-group-item d-flex jc-between bg-light'>
            ...
            <li className='list-group-item d-flex jc-between'>
              <span>Total (USD)</span>
              <strong>$20</strong>
            </li>
          </ul>
        ...
        <div className='col-md-7 col-lg-8 col-md-order-1'>
